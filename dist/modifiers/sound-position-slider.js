...
let SoundPositionSliderModifier = (_class = class SoundPositionSliderModifier extends DidPanModifier {
  constructor() {
    ...
    _defineProperty(this, "subscribedSound", null);
    _defineProperty(this, "isDraggingRange", false);
    _defineProperty(this, "afterLoadTask", buildTask(() => ({
      context: this,
      generator: function* (callback = function () {}) {
        while (!this.sound?.isResolved) {
          yield timeout(SOUND_RESOLVE_POLL_MS);
        }
        callback(this.sound);
      }
    }), null, "afterLoadTask", null));
  ...
  get canChangePosition() {
    return this.options.duration && this.options.position || this.sound && this.sound.isFastForwardable && this.sound.isRewindable;
  }
  ...
  onPositionChange() {
    if (this.isRangeControl && !this.isDraggingRange) {
  ...
  unsubscribeFromPosition() {
    if (this.subscribedSound) {
      this.subscribedSound.off('audio-position-changed', this.onPositionChange);
      this.subscribedSound = null;
    }
  }
  unregisterListeners() {
    // Ahead of the branch below, which throws once the element is gone and would strand the subscription.
    this.unsubscribeFromPosition();
    try {
      if (this.isRangeControl) {
        this.element.removeEventListener('change', this.onRangeControlChange, true);
        this.element.removeEventListener('input', this.onRangeControlInput);
      } else {
  ...
  writable: true,
  initializer: null
}), _applyDecoratedDescriptor(_class.prototype, "onRangeControlChange", [action], Object.getOwnPropertyDescriptor(_class.prototype, "onRangeControlChange"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "onRangeControlInput", [action], Object.getOwnPropertyDescriptor(_class.prototype, "onRangeControlInput"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "onPositionChange", [action], Object.getOwnPropertyDescriptor(_class.prototype, "onPositionChange"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "handleTap", [action], Object.getOwnPropertyDescriptor(_class.prototype, "handleTap"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "onPanStart", [action], Object.getOwnPropertyDescriptor(_class.prototype, "onPanStart"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "onPan", [action], Object.getOwnPropertyDescriptor(_class.prototype, "onPan"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "onPanEnd", [action], Object.getOwnPropertyDescriptor(_class.prototype, "onPanEnd"), _class.prototype), _class);
