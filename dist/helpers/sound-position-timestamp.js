...
/**
  ...
  @return {Date}
*/
class SoundPositionTimestamp extends StereoBaseIsHelper {
  constructor(...args) {
    super(...args);
    _defineProperty(this, "name", 'sound-position-timestamp');
  }
  get result() {
    let result;
...
export { SoundPositionTimestamp as default };
//# sourceMappingURL=sound-position-timestamp.js.map
