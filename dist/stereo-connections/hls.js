...
let HLSSound = (_class = (_class2 = class HLSSound extends Sound {
  constructor(...args) {
    super(...args);
    ...
    _initializerDefineProperty(this, "_currentTime", _descriptor4, this);
    _initializerDefineProperty(this, "_startTime", _descriptor5, this);
    _initializerDefineProperty(this, "_endTime", _descriptor6, this);
  }
  ...
  async loadHLS() {
    return import('hls.js').then(module => module.default).then(HLS => {
      return Promise.resolve({
        HLS: HLS
      });
    });
  }
}, _defineProperty(_class2, "acceptMimeTypes", ['application/vnd.apple.mpegurl']), _defineProperty(_class2, "key", 'HLS'), _class2), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "live", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "_currentTime", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, "_startTime", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor6 = _applyDecoratedDescriptor(_class.prototype, "_endTime", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
