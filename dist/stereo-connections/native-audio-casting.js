...
import DeadReckonClock from '../-private/utils/dead-reckon-clock.js';
 ...
 * @extends NativeAudio
 */
class NativeAudioCasting extends DeadReckonClock(NativeAudio) {
  constructor(...args) {
    super(...args);
    ...
    _defineProperty(this, "_lastReportedMs", null);
    // While settling a just-issued seek: the target to wait for and the deadline.
    _defineProperty(this, "_seekSettleTarget", null);
    _defineProperty(this, "_seekSettleUntil", 0);
  }
  static toString() {
  ...
  _currentPosition() {
    ...
    if (this._seekSettleTarget != null) {
      ...
      let caughtUp = reported != null && Math.abs(reported - this._seekSettleTarget) <= SEEK_SETTLE_TOLERANCE_MS;
  ...
  _cancelPendingSeek() {
    if (this._pendingSeekElement && this._pendingSeekApply) {
      this._pendingSeekElement.removeEventListener('loadedmetadata', this._pendingSeekApply);
    }
    this._pendingSeekElement = null;
    this._pendingSeekApply = null;
  }
...
_defineProperty(NativeAudioCasting, "key", 'NativeAudioCasting');

export { NativeAudioCasting as default };
//# sourceMappingURL=native-audio-casting.js.map
