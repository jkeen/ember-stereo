import { b as _defineProperty, _ as _applyDecoratedDescriptor, a as _initializerDefineProperty } from '../_rollupPluginBabelHelpers-fbb42d30.js';
...
var _dec, _dec2, _class, _descriptor, _descriptor2, _class2;
// These are the events we're watching for
const AUDIO_EVENTS = ['loadstart', 'durationchange', 'loadedmetadata', 'loadeddata', 'progress', 'canplay', 'canplaythrough', 'error', 'playing', 'pause', 'ended', 'seeking', 'seeked', 'emptied', 'timeupdate'];
 ...
 * @constructor
 */
let NativeAudio = (_dec = task({
  restartable: true
}), _dec2 = task({
  restartable: true
}), (_class = (_class2 = class NativeAudio extends Sound {
  constructor(...args) {
    super(...args);
    _initializerDefineProperty(this, "_internalElement", _descriptor, this);
    /* Public interface */
    _defineProperty(this, "_durationHistory", []);
    _initializerDefineProperty(this, "_durationHistory", _descriptor2, this);
  }
  ...
  get probablyAStream() {
    let differences = this._durationHistory.reduce((val, cur, index, original) => [...val, index === 0 ? 0 : original[index] - original[index - 1]], []);
...
}, _defineProperty(_class2, "key", 'NativeAudio'), _class2), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "_internalElement", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _applyDecoratedDescriptor(_class.prototype, "probablyAStream", [cached], Object.getOwnPropertyDescriptor(_class.prototype, "probablyAStream"), _class.prototype), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "_durationHistory", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _applyDecoratedDescriptor(_class.prototype, "durationWorkaroundTask", [_dec], Object.getOwnPropertyDescriptor(_class.prototype, "durationWorkaroundTask"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "playTask", [_dec2], Object.getOwnPropertyDescriptor(_class.prototype, "playTask"), _class.prototype)), _class));
