import { a as _initializerDefineProperty, b as _defineProperty, _ as _applyDecoratedDescriptor } from '../_rollupPluginBabelHelpers-fbb42d30.js';
import Service from '@ember/service';
import { tracked } from '@glimmer/tracking';
import { getOwner, setOwner } from '@ember/application';
import { makeArray, A } from '@ember/array';
import { assert } from '@ember/debug';
import { task, waitForEvent, didCancel, race, waitForProperty } from 'ember-concurrency';
...
import SoundProxy from '../-private/utils/sound-proxy.js';
...
let Stereo = (_dec = task({
  ...
  maxConcurrency: 5
}), (_class = class Stereo extends Service.extend(EmberEvented) {
  constructor() {
    super(...arguments);
    ...
    _defineProperty(this, "proxyCache", new UntrackedObjectCache());
    ...
    if (sound) {
      ...
      try {
        ...
        if (strategies.filter(s => s.canPlay).length == 0) {
          debug('ember-stereo:service')(`all strategies (${strategies.map(s => s.connectionName).join(', ')}) reported canPlay = false`);
      ...
      for (let strategy of strategies) {
        if (strategy.canPlay) {
          // worth trying
          let result = yield this.tryLoadingSoundTask.perform(strategy).catch(e => {
            strategy.error = e;
          });
          if (result.error) {
          ...
          if (result.sound) {
            debug('ember-stereo:service')(`firing sound-ready for ${result.sound.url}`);
  ...
  *playTask(urlsOrPromise, options = {}) {
    ...
    if (sound) {
      ...
      yield race([waitForProperty(sound, 'isPlaying'), waitForProperty(sound, 'isErrored')]);
  ...
  *waitForSuccessTask(strategy, sound) {
    ...
    debug('ember-stereo:service')(`SUCCESS: [${strategy.connectionName}] -> (${strategy.url})`);
  ...
  *waitForFailureTask(strategy, sound) {
    ...
    debug('ember-stereo:service')(`FAILED: [${strategy.connectionName}] -> ${sound.error} (${strategy.url})`);
  ...
  *tryLoadingSoundTask(strategy) {
    ...
    debug('ember-stereo:service')(`TRYING: [${strategy.connectionName}] -> ${strategy.url}`);
    strategy.tried = true;
    return yield race([this.waitForSuccessTask.perform(strategy, newSound), this.waitForFailureTask.perform(strategy, newSound)]);
  }
...
}), _applyDecoratedDescriptor(_class.prototype, "loadTask", [_dec], Object.getOwnPropertyDescriptor(_class.prototype, "loadTask"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "handleCurrentSoundTransitionTask", [task], Object.getOwnPropertyDescriptor(_class.prototype, "handleCurrentSoundTransitionTask"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "playTask", [_dec2], Object.getOwnPropertyDescriptor(_class.prototype, "playTask"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "resolveIdentifierTask", [_dec3], Object.getOwnPropertyDescriptor(_class.prototype, "resolveIdentifierTask"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "waitForSuccessTask", [task], Object.getOwnPropertyDescriptor(_class.prototype, "waitForSuccessTask"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "waitForFailureTask", [task], Object.getOwnPropertyDescriptor(_class.prototype, "waitForFailureTask"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "tryLoadingSoundTask", [task], Object.getOwnPropertyDescriptor(_class.prototype, "tryLoadingSoundTask"), _class.prototype)), _class));

export { EVENT_MAP, SERVICE_EVENT_MAP, Stereo as default };
