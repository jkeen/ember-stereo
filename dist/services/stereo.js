...
import { waitForEvent, race, waitForProperty, didCancel } from 'ember-concurrency';
...
let Stereo = (_class = class Stereo extends Service.extend(EmberEvented) {
  constructor() {
     ...
     * @return {Object} { sound }
     **/
    _defineProperty(this, "waitForSuccessTask", buildTask(() => ({
      context: this,
      generator: function* (strategy, sound) {
     ...
     * @return {Object} { error }
     **/
    _defineProperty(this, "waitForFailureTask", buildTask(() => ({
      context: this,
      generator: function* (strategy, sound) {
     ...
     **/
    _defineProperty(this, "tryLoadingSoundTask", buildTask(() => ({
      context: this,
      generator: function* (strategy) {
