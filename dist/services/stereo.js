...
import { waitForEvent, race, forever, timeout, didCancel } from 'ember-concurrency';
import { next, later, cancel } from '@ember/runloop';
import { macroCondition, isTesting } from '@embroider/macros';
import debug from 'debug';
import { TrackedSet } from 'tracked-built-ins';
import EmberEvented from '@ember/object/evented';
import OneAtATime from '../-private/utils/one-at-a-time.js';
import UrlCache from '../-private/utils/url-cache.js';
import MetadataCache from '../-private/utils/metadata-cache.js';
import SharedAudioAccess from '../-private/utils/shared-audio-access.js';
import SharedCastAccess from '../-private/utils/shared-cast-access.js';
import SoundCache from '../-private/utils/sound-cache.js';
import UntrackedObjectCache from '../-private/utils/untracked-object-cache.js';
import Strategizer from '../-private/utils/strategizer.js';
import Strategy from '../-private/utils/strategy.js';
import StereoUrl from '../-private/utils/stereo-url.js';
import Sound$1 from '../-private/utils/sound.js';
import ConnectionLoader from '../-private/utils/connection-loader.js';
...
import { loadCastSdk } from '../-private/utils/cast-sdk-loader.js';
import hasEqualUrls from '../-private/utils/has-equal-urls.js';
import normalizeIdentifier from '../-private/utils/normalize-identifier.js';
import { EVENT_MAP } from '../-private/utils/event-map.js';
export { SERVICE_EVENT_MAP } from '../-private/utils/event-map.js';

var _class, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor0, _descriptor1, _Stereo;
...
const MEDIA_SESSION_ACTIONS = ['play', 'pause', 'stop', 'seekbackward', 'seekforward', 'seekto', 'previoustrack', 'nexttrack'];
 ...
 * @constructor
 */
let Stereo = (_class = (_Stereo = class Stereo extends Service.extend(EmberEvented) {
  constructor() {
    super(...arguments);
    _initializerDefineProperty(this, "autoPlayAllowed", _descriptor, this);
    _initializerDefineProperty(this, "soundCache", _descriptor2, this);
    ...
    _initializerDefineProperty(this, "metadataCache", _descriptor3, this);
    _initializerDefineProperty(this, "urlCache", _descriptor4, this);
    _defineProperty(this, "soundEntityCache", new UntrackedObjectCache());
    // Only entities actually asked to load; the entity cache also fills with
    // speculative findSound lookups.
    _defineProperty(this, "loadedSounds", new TrackedSet());
    _defineProperty(this, "_soundsWithTransition", new WeakSet());
    /** currently loaded {Sound} object
     * @property currentSound
     * @type {Sound}
     * @public
     */
    _initializerDefineProperty(this, "_currentSound", _descriptor5, this);
    /**
    ...
    _initializerDefineProperty(this, "_playbackSpeed", _descriptor7, this);
    /**
     ...
     * @type {Boolean}
     */
    _initializerDefineProperty(this, "isMobileDevice", _descriptor8, this);
    /**
     ...
     * @public
     */
    _initializerDefineProperty(this, "isCasting", _descriptor9, this);
    /**
     ...
     * @public
     */
    _initializerDefineProperty(this, "castDeviceName", _descriptor0, this);
    /**
     ...
     * @type {Boolean}
     */
    _defineProperty(this, "_useSharedAudioElement", false);
    _defineProperty(this, "loadTask", buildTask(() => ({
      context: this,
      generator: function* (urlsOrPromise, _options) {
        ...
        let connection = yield entity.load(_options);
        if (connection) {
    ...
    _defineProperty(this, "handleCurrentSoundTransitionTask", buildTask(() => ({
      context: this,
      generator: function* (sound) {
    ...
    }), null, "handleCurrentSoundTransitionTask", null));
    /**
     ...
     */
    _defineProperty(this, "playTask", buildTask(() => ({
      context: this,
      generator: function* (urlsOrPromise, options = {}) {
        options = {
          metadata: {},
          ...options
        };
        ...
        if (previouslyPlayingSound && previouslyPlayingSound.urlsAreEqual && previouslyPlayingSound.urlsAreEqual(urlsOrPromise)) {
          return {
        ...
        this.trigger('new-load-request', {
          ...
          urlsOrPromise,
          options
        }); //urls: Promise.resolve(resolveUrls(urlsOrPromise))
        let {
          sound,
          entity,
          failures
        ...
        if (sound) {
          ...
          if (!sound.isPlaying && !sound.isErrored) {
            yield race([waitForEvent(sound, 'audio-played'), waitForEvent(sound, 'audio-load-error')]);
          }
          ...
          if (entity.isPlaying) {
            ...
            return this._handlePlaybackError({
              sound: entity,
              options
            });
          }
    ...
    _defineProperty(this, "resolveIdentifierTask", buildTask(() => ({
      context: this,
     ...
     */
    _defineProperty(this, "castingTypes", new TrackedSet());
    _initializerDefineProperty(this, "_activeCastBackend", _descriptor1, this);
    ...
    _defineProperty(this, "_castContext", null);
    _defineProperty(this, "_castAccess", new SharedCastAccess());
    _defineProperty(this, "_detectCastingAvailabilityTask", buildTask(() => ({
      context: this,
      generator: function* () {
        ...
        try {
          if (element.remote && typeof element.remote.watchAvailability === 'function') {
            element.remote.watchAvailability(available => {
              if (available) {
                this.castingTypes.add(CASTING_TYPE.REMOTE_PLAYBACK_API);
              } else {
                this.castingTypes.delete(CASTING_TYPE.REMOTE_PLAYBACK_API);
              }
          ...
          if ('webkitShowPlaybackTargetPicker' in element) {
            this._onOutletAvailabilityChange = event => {
              if (event.availability === 'available') {
                this.castingTypes.add(CASTING_TYPE.WEBKIT_AIRPLAY);
              } else {
                this.castingTypes.delete(CASTING_TYPE.WEBKIT_AIRPLAY);
              }
              this._triggerCastAvailabilityChanged();
            };
            element.addEventListener('webkitplaybacktargetavailabilitychanged', this._onOutletAvailabilityChange);
          }
      ...
      maxConcurrency: 1
    }, "_detectCastingAvailabilityTask", null));
    _defineProperty(this, "_chromecastSetupStarted", false);
    ...
    _defineProperty(this, "_castTargetSettleTask", buildTask(() => ({
      context: this,
      generator: function* () {
    ...
    _defineProperty(this, "engageCastTask", buildTask(() => ({
      context: this,
      generator: function* () {
        this.isCasting = true;
        this.castDeviceName = this._castDeviceLabel();
        let sound = this.currentSound;
        debug('ember-stereo:service')(`engaging cast -> ${sound?.castUrl ?? '(no current sound; route held, awaiting one)'}`);
        this.trigger('audio-cast-connecting', {
          sound
        });
        // Re-engaging an already-cast sound (spurious SESSION_RESUMED, mid-flight
        // feed switch) would re-cast the wrong feed.
        if (this._isLocalSoundReadyToCast(sound)) {
          // A live stream handed a currentTime it can't reach buffers forever on
          // the receiver.
          let startTime = sound.isStream ? null : sound.position;
          let cast = this._buildCastConnection(sound.castUrl, sound.metadata, startTime);
          if (cast) {
            yield sound.swap(cast);
          }
        }
        this.trigger('audio-cast-connected', {
          sound
        });
      }
    }), {
    ...
    _defineProperty(this, "disengageCastTask", buildTask(() => ({
      context: this,
      generator: function* () {
        if (!this.isCasting) {
          return;
        ...
        debug('ember-stereo:service')(`disengaging cast (backend=${backend}, playIntent=${sound?._playIntent})`);
        this.isCasting = false;
        this.castDeviceName = null;
        this._activeCastBackend = null;
        if (sound && this._isCastConnection(sound.value)) {
          if (backend === CASTING_TYPE.CAST_SDK) {
            // A user-initiated stop carries activation, so a fresh local
            // connection is allowed to resume.
        ...
        this.trigger('audio-cast-disconnected', {
          sound
        });
      }
    }), {
      restartable: true
    }, "disengageCastTask", null));
    /* ------------------------ PRIVATE(ISH) STUFF ------------------------------ */
    /* -------------------------------------------------------------------------- */
    /* -------------------------------------------------------------------------- */
    _defineProperty(this, "config", getOwner(this).resolveRegistration('config:environment'));
    _defineProperty(this, "_positionStateUpdatedAt", 0);
    _defineProperty(this, "_mediaSessionActions", new Map());
    const owner = getOwner(this);
    owner.registerOptionsForType('ember-stereo@stereo-connection', {
      instantiate: false
    });
    owner.registerOptionsForType('stereo-connection', {
      instantiate: false
    });
    ...
    if (macroCondition(isTesting())) ; else if (!fastboot?.isFastBoot) {
  ...
  get currentMetadata() {
    ...
    return this.metadataCache.find(this.currentSound?.url) || this.metadataCache.find(this.currentSound?.identifier);
  }
  ...
  prewarmConnection(connectionKey) {
    ...
    if (!connection) {
      debug('ember-stereo:service')(`can't warm unknown connection ${connectionKey}`);
      return Promise.resolve();
    }
    return connection.preload();
  }
  _findConnection(connectionKey) {
    let registered = this.connectionLoader.get(connectionKey) || this.connectionLoader.connections.find(candidate => candidate.key === connectionKey);
    if (registered) {
      return registered;
    }

    // Casting connections are service-built and force-injected, never registered.
    return [Chromecast, NativeAudioCasting].find(candidate => candidate.key === connectionKey);
  }
  ...
  _determineAutoplayPermissions() {
    ...
    import('can-autoplay').then(({
      default: canAutoplay
    }) => {
      canAutoplay.audio().then(({
        result
      }) => {
        if (result) {
   ...
   */
  get castIconName() {
    let kind = this._activeCastBackend || (this.castingTypes.has(CASTING_TYPE.CAST_SDK) ? CASTING_TYPE.CAST_SDK : CASTING_TYPE.WEBKIT_AIRPLAY);
  ...
  get castOutletElement() {
    if (!this._castOutletElement) {
      ...
      this._onOutletWirelessChange = () => this._onCastTargetChange(!!element.webkitCurrentPlaybackTargetIsWireless);
      element.addEventListener('webkitcurrentplaybacktargetiswirelesschanged', this._onOutletWirelessChange);
      if (element.remote) {
  ...
  async _setupChromecast() {
    ...
    let syncAvailability = () => {
      if (context.getCastState() !== CastState.NO_DEVICES_AVAILABLE) {
        this.castingTypes.add(CASTING_TYPE.CAST_SDK);
      } else {
        this.castingTypes.delete(CASTING_TYPE.CAST_SDK);
      }
      this._triggerCastAvailabilityChanged();
    };
    context.addEventListener(CastContextEventType.CAST_STATE_CHANGED, syncAvailability);
    context.addEventListener(CastContextEventType.SESSION_STATE_CHANGED, event => this._onChromecastSessionChange(event.sessionState));
    syncAvailability();
  }
  _onChromecastSessionChange(sessionState) {
    ...
    if (sessionState === SessionState.SESSION_STARTED || sessionState === SessionState.SESSION_RESUMED) {
      this._activeCastBackend = CASTING_TYPE.CAST_SDK;
      this._castAccess.attach(this._castContext.getCurrentSession(), window.cast.framework);
  ...
  _triggerCastAvailabilityChanged() {
    debug('ember-stereo:service')(`cast availability: ${[...this.castingTypes]}`);
  ...
  showCastMenu(identifier) {
    ...
    if (this.castingTypes.has(CASTING_TYPE.CAST_SDK) && this._castContext) {
  ...
  stopCasting() {
    ...
    if (this._activeCastBackend === CASTING_TYPE.CAST_SDK && this._castContext) {
  ...
  _castsWithoutOutletElement() {
    return this.castingTypes.has(CASTING_TYPE.CAST_SDK) && !this.castingTypes.has(CASTING_TYPE.WEBKIT_AIRPLAY);
  }
  _loadOutlet(identifier) {
    if (this._castsWithoutOutletElement()) {
      return;
    }
  ...
  _onCastTargetChange(isWireless) {
    ...
    if (this._suppressCastTargetChange) {
      debug('ember-stereo:service')(`cast-target change ignored (programmatic outlet change): wireless=${isWireless}`);
      return;
    }
    debug('ember-stereo:service')(`cast-target change: wireless=${isWireless} -> ${isWireless ? 'engage' : 'disengage'}`);
    if (isWireless) {
      this._activeCastBackend = CASTING_TYPE.WEBKIT_AIRPLAY;
      this.engageCastTask.perform().catch(e => {
        if (!didCancel(e)) throw e;
      });
    } else {
  ...
  _reconcileCastState() {
    ...
    // Chromecast isn't element-based: the webkit flag is always false here and
    // would disengage a live Cast session.
    if (this._activeCastBackend === CASTING_TYPE.CAST_SDK) {
      return;
    }
    let actuallyCasting = !!element.webkitCurrentPlaybackTargetIsWireless || element.remote?.state === 'connected';
    debug('ember-stereo:service')(`reconcile cast state: actuallyCasting=${actuallyCasting} isCasting=${this.isCasting}`);
  ...
  _isLocalSoundReadyToCast(sound) {
    return !!sound?.castUrl && !this._isCastConnection(sound.value);
  }

  // AirPlay/WebKit withholds the device name, so fall back to the transport.
  _castDeviceLabel() {
    if (this._activeCastBackend === CASTING_TYPE.CAST_SDK) {
  ...
  _shouldCastUrl(castUrl) {
    return this.isCasting && castUrl != null && (this._activeCastBackend !== CASTING_TYPE.CAST_SDK || !!this._castAccess.session);
  }
  ...
  _isStaleCastValue(connection) {
    return this._activeCastBackend === CASTING_TYPE.CAST_SDK && connection?.connectionKey === Chromecast.key && !this._castAccess.hasControl(connection);
  }
  _findLocalStrategy(strategies) {
    return (strategies || []).find(candidate => candidate.canPlay && !this._isCastConnection(candidate));
  }
  _buildLocalConnection(sound) {
    ...
    if (!strategy) {
      let strategies = this._buildStrategies(makeArray(sound.identifier), this.prepareLoadOptions(sound.options));
  ...
  _buildStrategies(urlsToTry, options) {
    ...
    if (this._shouldCastUrl(options.castUrl)) {
      debug('ember-stereo:service')(`casting active: cast strategy (local fallback) for ${options.castUrl}`);
      return [this._castStrategy(options.castUrl, options.metadata, options.castStartTime), ...localStrategies];
    }
  ...
  _handleLoadError({
    ...
    if (!this._shouldSilenceErrors(options)) {
      throw new Error(errorMessage || 'stereo load error', {
        failures
      });
    }
    return {
  ...
  _errorMessageFromFailures(failures) {
    let nativeAudioFailure = makeArray(failures).find(failure => failure.connectionKey === 'NativeAudio');
    let errorMessage = '';
    if (nativeAudioFailure) {
      errorMessage = nativeAudioFailure.error;
    } else {
      errorMessage = makeArray(failures).map(f => f.error).filter(f => f.toString().length > 0)[0];
    }
    return errorMessage;
  }
  ...
  loadConnections(connections = this.systemStereoOptions?.connections || A(DEFAULT_CONNECTIONS)) {
  ...
  findLoadedSound(identifiers) {
    if (identifiers instanceof Sound) {
      return identifiers;
    } else {
  ...
  findSound(identifier) {
    if (identifier instanceof Sound || identifier instanceof Sound$1) {
      return identifier;
    }
    if (!identifier) {
      return undefined;
    ...
    let sound = new Sound$1(identifier, {
      owner: getOwner(this)
    });
  ...
  // The event names the state; reading it off the sound can be beaten by the
  // next event's write. A replaced sound still pauses on its way out, and
  // relaying that would show paused while its replacement plays.
  ...
  _updateNowPlaying(sound, playbackState) {
    ...
    if (window && navigator && 'mediaSession' in navigator && 'MediaMetadata' in window) {
      navigator.mediaSession.playbackState = playbackState ?? (sound.isPlaying ? 'playing' : 'paused');
      let {
        title,
        artist,
        album,
      ...
      let handlerFor = (action, fallback, argument = info => info) => {
        ...
        // Looked up when pressed: overrides can register after install.
        return info => {
      ...
      navigator.mediaSession.setActionHandler('play', handlerFor('play', () => {
        if (!sound.isPlaying) {
          sound.play();
        }
      }));
      navigator.mediaSession.setActionHandler('pause', handlerFor('pause', () => {
        if (sound.isPlaying) {
          sound.pause();
        }
      }));
      navigator.mediaSession.setActionHandler('stop', handlerFor('stop', () => sound.stop()));
      navigator.mediaSession.setActionHandler('seekbackward', handlerFor('seekbackward', seekInfo => {
        if (sound.isRewindable) {
          sound.rewind(seekOffsetMs(seekInfo));
        }
      }, seekOffsetMs));
      navigator.mediaSession.setActionHandler('seekforward', handlerFor('seekforward', seekInfo => {
        if (sound.isFastForwardable) {
          sound.fastForward(seekOffsetMs(seekInfo));
        }
      }, seekOffsetMs));
      navigator.mediaSession.setActionHandler('seekto', handlerFor('seekto', seekInfo => {
        if (sound.isSeekable) {
      ...
      navigator.mediaSession.setActionHandler('previoustrack', handlerFor('previoustrack', null));
      navigator.mediaSession.setActionHandler('nexttrack', handlerFor('nexttrack', null));
    }
  }
  ...
  _updatePositionState(sound) {
    if (!sound || sound.isDestroyed || typeof navigator === 'undefined' || !('mediaSession' in navigator) || typeof navigator.mediaSession.setPositionState !== 'function') {
      return;
    }
    ...
    if (!timeline && !sound.isSeekable || !Number.isFinite(duration) || duration <= 0) {
      try {
        navigator.mediaSession.setPositionState();
      } catch (e) {
        // nothing to clear
  ...
  _updatePositionStateThrottled() {
    if (Date.now() - this._positionStateUpdatedAt < Stereo.POSITION_STATE_INTERVAL_MS) {
      return;
    }
  ...
  _attemptToPlaySound(sound, options) {
    ...
    let touchPlay = () => {
      debug('ember-stereo:service')(`triggering sound play from document touch`);
      sound.play();
    };
    ...
    let blockCheck = later(() => {
      debug('ember-stereo:service')(`Looks like the mobile browser blocked an autoplay trying to play sound with url: ${sound.url}`);
  ...
  _teardownCastOutlet() {
    ...
    if (this._onOutletWirelessChange) {
      element.removeEventListener('webkitcurrentplaybacktargetiswirelesschanged', this._onOutletWirelessChange);
      this._onOutletWirelessChange = null;
    }
    if (this._onOutletAvailabilityChange) {
      element.removeEventListener('webkitplaybacktargetavailabilitychanged', this._onOutletAvailabilityChange);
...
}, _defineProperty(_Stereo, "POSITION_STATE_INTERVAL_MS", 1000), _Stereo), _descriptor = _applyDecoratedDescriptor(_class.prototype, "autoPlayAllowed", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "soundCache", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "metadataCache", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "urlCache", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, "_currentSound", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor7 = _applyDecoratedDescriptor(_class.prototype, "_playbackSpeed", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor8 = _applyDecoratedDescriptor(_class.prototype, "isMobileDevice", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor9 = _applyDecoratedDescriptor(_class.prototype, "isCasting", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor0 = _applyDecoratedDescriptor(_class.prototype, "castDeviceName", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor1 = _applyDecoratedDescriptor(_class.prototype, "_activeCastBackend", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
export { EVENT_MAP, Stereo as default };
