...
import ErrorCache from '../-private/utils/error-cache.js';
 ...
 * @constructor
 */
let Stereo = (_class = class Stereo extends Service.extend(EmberEvented) {
  constructor() {
    super(...arguments);
    ...
    _initializerDefineProperty(this, "errorCache", _descriptor3, this);
    _initializerDefineProperty(this, "metadataCache", _descriptor4, this);
    _initializerDefineProperty(this, "urlCache", _descriptor5, this);
     ...
     * @public
     */
    _initializerDefineProperty(this, "_currentSound", _descriptor6, this);
    /**
     ...
     * @type {Integer}
     */
    _initializerDefineProperty(this, "_volume", _descriptor7, this);
    _initializerDefineProperty(this, "_playbackSpeed", _descriptor8, this);
    /**
     ...
     * @type {Boolean}
     */
    _initializerDefineProperty(this, "isMobileDevice", _descriptor9, this);
    /**
     ...
     * @public
     */
    _initializerDefineProperty(this, "isCasting", _descriptor0, this);
    /**
     ...
     * @public
     */
    _initializerDefineProperty(this, "castDeviceName", _descriptor1, this);
    /**
    ...
    _defineProperty(this, "playTask", buildTask(() => ({
      ...
      generator: function* (urlsOrPromise, options = {}) {
        ...
        if (sound) {
          ...
          // Wait on the connection's real events — isPlaying/isErrored are set in
          // response to audio-played / audio-load-error on the backend itself, not
          // the Sound's proxy getters. Guard the already-settled case the way the
          // old observer-based waitForProperty did (it checked the value up front).
    ...
    _initializerDefineProperty(this, "_activeCastBackend", _descriptor10, this);
   ...
   */
  get castIconName() {
    let kind = this._activeCastBackend || (this.castingTypes.has('chromecast') ? 'chromecast' : 'airplay');
  ...
  _shouldCastUrl(castUrl) {
    return this.isCasting && castUrl != null && (this._activeCastBackend !== 'chromecast' || !!this._castAccess.session);
  }
  ...
  _isStaleCastValue(connection) {
    return this._activeCastBackend === 'chromecast' && connection?.connectionKey === Chromecast.key && !this._castAccess.hasControl(connection);
  }
...
}, _descriptor = _applyDecoratedDescriptor(_class.prototype, "autoPlayAllowed", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "errorCache", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "metadataCache", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, "urlCache", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor6 = _applyDecoratedDescriptor(_class.prototype, "_currentSound", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor7 = _applyDecoratedDescriptor(_class.prototype, "_volume", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor8 = _applyDecoratedDescriptor(_class.prototype, "_playbackSpeed", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor9 = _applyDecoratedDescriptor(_class.prototype, "isMobileDevice", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor0 = _applyDecoratedDescriptor(_class.prototype, "isCasting", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor1 = _applyDecoratedDescriptor(_class.prototype, "castDeviceName", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor10 = _applyDecoratedDescriptor(_class.prototype, "_activeCastBackend", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
