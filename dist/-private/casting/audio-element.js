...
import SharedAudioAccess from '../utils/shared-audio-access.js';
import { SILENT_SOURCE } from '../utils/silent-source.js';
...
class CastAudioElement {
  constructor({
    ...
    _defineProperty(this, "_access", null);
    this._createElement = createElement ?? (() => document.createElement('audio'));
  }
  get hasElement() {
...
export { CastAudioElement as default };
