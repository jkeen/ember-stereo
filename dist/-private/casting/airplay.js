 ...
 * @class AirplayDriver
 */
let AirplayDriver = (_class = class AirplayDriver {
  constructor({
    audioElement,
    ...
    _initializerDefineProperty(this, "deviceAvailable", _descriptor, this);
  ...
  watch() {
    ...
    element.addEventListener('webkitplaybacktargetavailabilitychanged', this._availabilityListener);
  ...
  unwatch() {
    ...
    if (this._availabilityListener) {
      element.removeEventListener('webkitplaybacktargetavailabilitychanged', this._availabilityListener);
...
}, _descriptor = _applyDecoratedDescriptor(_class.prototype, "deviceAvailable", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
