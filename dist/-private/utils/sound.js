...
import isSameAudio from './is-same-audio.js';
...
const RELAYED_EVENTS = [...EVENT_MAP.map(({
  event
...
let Sound = (_class = class Sound extends Evented {
  constructor(identifier, _options = {}) {
    ...
    _initializerDefineProperty(this, "_identifier", _descriptor, this);
    ...
    _initializerDefineProperty(this, "_connection", _descriptor5, this);
    ...
    _initializerDefineProperty(this, "_castUrl", _descriptor8, this);
    _initializerDefineProperty(this, "_metadata", _descriptor9, this);
    _initializerDefineProperty(this, "_debug", _descriptor0, this);
    _initializerDefineProperty(this, "_collapsedInto", _descriptor1, this);
    _defineProperty(this, "_explicitPlayIntent", false);
    _defineProperty(this, "_urlsPromise", null);
    ...
    _defineProperty(this, "loadTask", buildTask(() => ({
      ...
      generator: function* (loadOptions = {}) {
        ...
        if (this.isResolved && !this.connection.isErrored) {
          ...
          let target = castingThisUrl ? this.stereo.cast.buildCastConnection(options.castUrl, this.metadata, {
        ...
        let urls = yield this.resolveUrls();
        ...
        for (let strategy of this.strategies) {
          ...
          let {
            ...
            error,
            erroredConnection
          } = yield race([this.waitForReadyTask.perform(candidate), this.waitForErrorTask.perform(candidate)]);
          if (connection) {
   ...
   */
  get urls() {
    let candidates = [...makeArray(this._identifier), this.connection?.url, this._castUrl];
    return [...new Set(candidates.map(candidate => typeof candidate === 'string' ? candidate : candidate?.url).filter(Boolean))];
  }
  ...
  set connection(connection) {
    debug('ember-stereo:sound')(`set connection: ${connection?.connectionName} -> ${connection?.url}`);
  ...
  _warnIfCastingLocally(connection) {
    ...
    console.warn(`ember-stereo: casting is active, but ${this.url} resolved to ${connection.connectionName} and will play locally. The device could not fetch its castUrl (${this.castUrl}).`);
  }
   ...
   */
  get isLoading() {
    return this.loadTask.isRunning || this.swapTask.isRunning || this.connection?.isLoading || false;
  }
  ...
  get errors() {
    ...
    return this.connection?.error ? [...strategyErrors, this.connection.error] : strategyErrors;
  }
  ...
  _castStateMatches() {
    ...
    if (this.stereo.cast.isCasting) {
      return connectionIsCast && !this.stereo.cast.isStaleCastConnection(this.connection);
    }
   ...
   * @public
   */
  hasUrl(identifier, options = {
    exact: false
  }) {
    if (isSameAudio(this.urls, identifier, options)) {
      return true;
    }
    return makeArray(this._identifier).some(mine => makeArray(identifier).includes(mine));
  }
  _setVolume(volume) {
    this._volume = volume;
...
}, _descriptor = _applyDecoratedDescriptor(_class.prototype, "_identifier", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
...
}), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, "_connection", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor8 = _applyDecoratedDescriptor(_class.prototype, "_castUrl", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor9 = _applyDecoratedDescriptor(_class.prototype, "_metadata", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor0 = _applyDecoratedDescriptor(_class.prototype, "_debug", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor1 = _applyDecoratedDescriptor(_class.prototype, "_collapsedInto", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
