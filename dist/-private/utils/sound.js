...
let Sound = (_class = class Sound extends Evented {
  constructor(identifier, _options = {}) {
    ...
    _defineProperty(this, "_relayHandlers", new Map());
    _defineProperty(this, "loadTask", buildTask(() => ({
      ...
      generator: function* (loadOptions = {}) {
        ...
        if (this.isResolved && !this.value.isErrored) {
          ...
          let target = castingThisUrl ? this.stereo._buildCastConnection(options.castUrl, this.metadata,
          // Only seekable media gets a start position; seeking a live stream
          // makes the receiver buffer forever (see engageCastTask).
          this.isStream ? null : this.position) : this.stereo._buildLocalConnection(this);
          if (target) {
