...
// Resolve relative URLs the way an anchor element would (against the page URL), but without touching
// the DOM so identifiers can be normalized in FastBoot, where `document` doesn't exist.
