...
import { animationFrame, rawTimeout } from 'ember-concurrency';
...
let FakeMediaElement = (_class = class FakeMediaElement extends Evented {
  constructor() {
    ...
    _initializerDefineProperty(this, "readyState", _descriptor0, this);
    _initializerDefineProperty(this, "crossOrigin", _descriptor1, this);
    _initializerDefineProperty(this, "_currentTime", _descriptor10, this);
    _defineProperty(this, "startTickingTask", buildTask(() => ({
      context: this,
      generator: function* () {
  ...
  // Mirrors HTMLMediaElement#seekable's TimeRanges shape.
  get seekable() {
...
}), _descriptor0 = _applyDecoratedDescriptor(_class.prototype, "readyState", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor1 = _applyDecoratedDescriptor(_class.prototype, "crossOrigin", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor10 = _applyDecoratedDescriptor(_class.prototype, "_currentTime", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
