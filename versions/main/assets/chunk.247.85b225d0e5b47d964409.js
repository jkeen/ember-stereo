/*! For license information please see chunk.247.85b225d0e5b47d964409.js.LICENSE.txt */
...
r.r(t),r.d(t,{EVENT_MAP:()=>Ae,SERVICE_EVENT_MAP:()=>xe,default:()=>Xe})
...
var Se,Ce,Te,Re,Oe,De,Pe,Ne,Le,je,Me
const Ie=[...Ae.map(({event:e})=>e),"audio-load-error"]
let qe=(Se=class extends ke.A{constructor(e,t={}){super(...arguments),(0,n.a)(this,"_identifier",Ce,this),(0,n.a)(this,"options",Te,this),(0,n.a)(this,"strategies",Re,this),(0,n.a)(this,"failures",Oe,this),(0,n.a)(this,"_connection",De,this),(0,n.a)(this,"_volume",Pe,this),(0,n.a)(this,"_castUrl",Ne,this),(0,n.a)(this,"_metadata",Le,this),(0,n.a)(this,"_debug",je,this),(0,n.a)(this,"_collapsedInto",Me,this),(0,n.b)(this,"_explicitPlayIntent",!1),(0,n.b)(this,"_urlsPromise",null),(0,n.b)(this,"_boundRelayHandlers",new Map),(0,n.b)(this,"loadTask",(0,i.buildTask)(()=>({context:this,generator:function*(e={}){this.stereo?._soundLoadStarted(this),this.stereo?.oneAtATime?.register(this)
...
return{position:e?.position,isPlaying:this._explicitPlayIntent,isStream:e?.isStream}}_registerEventRelays(e){e&&Ie.forEach(t=>{let r=e=>this._relayEvent(t,e)
this._boundRelayHandlers.set(t,r),e.on(t,r)})}_relayEvent(e,t={}){"audio-played"===e&&(this._explicitPlayIntent=!0),this.trigger(e,{...t,sound:this})}_unregisterEventRelays(e){e&&Ie.forEach(t=>{let r=this._boundRelayHandlers.get(t)
if(r){try{e.off(t,r)}catch(e){}this._boundRelayHandlers.delete(t)}})}_needsConnectionReresolve(){return this.isResolved&&!this._castStateMatches()}play(...e){return this._explicitPlayIntent=!0,this._needsConnectionReresolve()?this.load():this.connection?.play(...e)}pause(...e){return this._explicitPlayIntent=!1,this.connection?.pause(...e)}stop(...e){return this._explicitPlayIntent=!1,this.connection?.stop(...e)}togglePause(...e){return this._explicitPlayIntent=!this.isPlaying,this._needsConnectionReresolve()?this.load():this.connection?.togglePause(...e)}rewind(...e){return this.connection?.rewind(...e)}fastForward(...e){return this.connection?.fastForward(...e)}seek(...e){return this.connection?.seek(...e)}hasUrl(e,t={exact:!1}){return!!(0,Ee.A)(this.urls,e,t)||(0,c.makeArray)(this._identifier).some(t=>(0,c.makeArray)(e).includes(t))}_setVolume(e){this._volume=e,this.connection?._setVolume(e)}get position(){return this.connection?.position}set position(e){this.connection&&(this.connection.position=e)}get duration(){return this.connection?.duration}get currentTime(){return this.connection?.currentTime}get startTime(){return this.connection?.startTime}get endTime(){return this.connection?.endTime}get percentLoaded(){return this.connection?.percentLoaded}get isBlocked(){return this.connection?.isBlocked}set isBlocked(e){this.connection&&(this.connection.isBlocked=e)}get isReady(){return this.connection?.isReady}get isPlaying(){return this.connection?.isPlaying}get isPaused(){return this.connection?.isPaused}get isLoaded(){return this.connection?.isLoaded}get hasPlayed(){return this.connection?.hasPlayed}get mimeType(){return this.connection?.mimeType}get isStream(){return this.connection?.isStream}get isRewindable(){return this.connection?.isRewindable}get isFastForwardable(){return this.connection?.isFastForwardable}get isSeekable(){return this.connection?.isSeekable}get id3Tags(){return this.connection?.id3Tags}get id3TagMetadata(){return this.connection?.id3TagMetadata}get connectionName(){return this.connection?.connectionName}get connectionKey(){return this.connection?.connectionKey}},Ce=(0,n._)(Se.prototype,"_identifier",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Te=(0,n._)(Se.prototype,"options",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Re=(0,n._)(Se.prototype,"strategies",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Oe=(0,n._)(Se.prototype,"failures",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return[]}}),De=(0,n._)(Se.prototype,"_connection",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),Pe=(0,n._)(Se.prototype,"_volume",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Ne=(0,n._)(Se.prototype,"_castUrl",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),Le=(0,n._)(Se.prototype,"_metadata",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return{}}}),je=(0,n._)(Se.prototype,"_debug",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return{}}}),Me=(0,n._)(Se.prototype,"_collapsedInto",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),Se)
var Fe,Be,ze,$e=r(7655)
let Ue=(Fe=class{constructor(e,t){(0,n.a)(this,"loaded",Be,this),(0,n.a)(this,"connectionOrder",ze,this),this.service=e,this.load(t),this.connectionOrder=t.map(e=>"string"==typeof e?e:e.name)}get connections(){return this.names.map(e=>this.loaded[e])}get names(){return this.connectionOrder.filter(e=>!!this.loaded[e])}get(e){return this.loaded[e]}load(e){(0,u.assert)(`[ember-stereo] ConnectionLoader needs an array of connection, you provided ${e}`,!(0,ve.isEmpty)(e)),e.forEach(e=>{let t,r
...
const t=(0,$e._k)(e),r=(0,l.getOwner)(this.service).lookup(`ember-stereo@stereo-connection:${t}`),n=(0,l.getOwner)(this.service).lookup(`stereo-connection:${t}`)
return(0,u.assert)(`[ember-stereo] Could not load stereo connection ${t}`,n||r),n||r}},Be=(0,n._)(Fe.prototype,"loaded",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return{}}}),ze=(0,n._)(Fe.prototype,"connectionOrder",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return[]}}),Fe)
var He,Ve,We,Ge,Ke,Qe,Ze
const Ye=[{name:"NativeAudio"},{name:"Howler"},{name:"HLS"}],Je=["play","pause","stop","seekbackward","seekforward","seekto","previoustrack","nexttrack"]
let Xe=(Ze=class e extends(o().extend(I())){constructor(){super(...arguments),(0,n.a)(this,"autoPlayAllowed",Ve,this),(0,n.b)(this,"_identityMap",new ge),(0,n.b)(this,"_sounds",new w),(0,n.b)(this,"_previewSounds",new WeakSet),(0,n.a)(this,"_currentSound",We,this),(0,n.a)(this,"_volume",Ge,this),(0,n.a)(this,"_playbackSpeed",Ke,this),(0,n.a)(this,"isMobileDevice",Qe,this),(0,n.b)(this,"_useSharedAudioElement",!1),(0,n.b)(this,"loadTask",(0,i.buildTask)(()=>({context:this,generator:function*(e,t){let r={metadata:{},...t}
...
t!==e&&(this._unregisterEvents(t),t?.isPlaying&&this.trigger("current-sound-interrupted",{sound:t}),e?(this._registerEvents(e),this._updateNowPlaying(e),e._setVolume(this.volume),f()("ember-stereo:service")(`setting current sound -> ${e.url}`)):(this._clearNowPlaying(),f()("ember-stereo:service")("setting current sound -> null")),this._currentSound=e,this.trigger("current-sound-changed",{sound:e,previousSound:t}))}loadConnections(e=this.systemStereoOptions?.connections||(0,c.A)(Ye)){return this.connectionLoader=new Ue(this,e),(0,l.setOwner)(this.connectionLoader,(0,l.getOwner)(this)),this}get connections(){return this.connectionLoader.connections}get connectionNames(){return this.connectionLoader.names}get sounds(){return[...this._sounds]}findSound(e){if(e instanceof qe)return e
if(!e)return
let t=(0,c.makeArray)(e)[0],r=this._identityMap.find(t)
if(r)return r.canonical
let n=new qe(e,{owner:(0,l.getOwner)(this)})
...
try{navigator.mediaSession.setPositionState()}catch(e){}Je.forEach(e=>{try{navigator.mediaSession.setActionHandler(e,null)}catch(e){}})}}_updatePositionState(e){if(!e||"undefined"==typeof navigator||!("mediaSession"in navigator)||"function"!=typeof navigator.mediaSession.setPositionState)return
...
document.addEventListener("touchstart",r,{passive:!0}),e.one("audio-played",()=>{document.removeEventListener("touchstart",r)}),e.play(t)}willDestroy(){this.loadTask.cancelAll(),this.playTask.cancelAll(),this.cast.teardown()}},(0,n.b)(Ze,"POSITION_STATE_INTERVAL_MS",1e3),He=Ze,Ve=(0,n._)(He.prototype,"autoPlayAllowed",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),We=(0,n._)(He.prototype,"_currentSound",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),Ge=(0,n._)(He.prototype,"_volume",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return this.defaultVolume}}),Ke=(0,n._)(He.prototype,"_playbackSpeed",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return this.defaultPlaybackSpeed}}),Qe=(0,n._)(He.prototype,"isMobileDevice",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return"ontouchstart"in window}}),He)},1998:function(e,t,r){"use strict"
var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}}
...
//# sourceMappingURL=chunk.247.85b225d0e5b47d964409.map