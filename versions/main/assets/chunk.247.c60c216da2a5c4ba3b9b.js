/*! For license information please see chunk.247.c60c216da2a5c4ba3b9b.js.LICENSE.txt */
...
null!=s&&isFinite(s)&&s>0&&(i.currentTime=s/1e3),e.loadMedia(i).then(()=>this._onLoaded(),e=>this.trigger("audio-load-error",{sound:this,error:this._describeError(e)}))}_onLoaded(){this.trigger("audio-duration-changed",{sound:this}),this.trigger("audio-ready",{sound:this}),this.trigger("audio-loaded",{sound:this})}_describeError(e){return e?e.description||e.code||String(e):"Chromecast load error"}_onPlayerStateChanged(){let e=window.chrome.cast.media.PlayerState
...
return e&&isFinite(e)?1e3*e:1/0}_setPlaybackSpeed(){}_setVolume(e){this._hasControl&&this._player&&this._controller&&(this._player.volumeLevel=e/100,this._controller.setVolumeLevel())}play(){let e=window.chrome.cast.media.PlayerState,t=this._player?.playerState
...
t!==e&&(this._unregisterEvents(t),t?.isPlaying&&this.trigger("current-sound-interrupted",{sound:t}),e?(this._registerEvents(e),this._updateNowPlaying(e),e._setVolume(this.volume),e._setPlaybackSpeed(this.playbackSpeed),f()("ember-stereo:service")(`setting current sound -> ${e.url}`)):(this._clearNowPlaying(),f()("ember-stereo:service")("setting current sound -> null")),this._currentSound=e,this.trigger("current-sound-changed",{sound:e,previousSound:t}))}loadConnections(e=this.systemStereoOptions?.connections||(0,c.A)(Je)){return this.connectionLoader=new He(this,e),(0,l.setOwner)(this.connectionLoader,(0,l.getOwner)(this)),this}get connections(){return this.connectionLoader.connections}get connectionNames(){return this.connectionLoader.names}get sounds(){return[...this._sounds]}findSound(e){if(e instanceof Fe)return e
if(!e)return
...
//# sourceMappingURL=chunk.247.c60c216da2a5c4ba3b9b.map