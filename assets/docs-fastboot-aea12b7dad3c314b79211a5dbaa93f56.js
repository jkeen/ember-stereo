...
najax(e)}
e.default={name:"ajax-service",initialize:function(e){e.register("ajax:node",r,{instantiate:!1})}}}),define("docs/initializers/error-handler",["exports","ember"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
console.error(t)})}}}),define("docs/instance-initializers/setup-fetch",["exports","fetch"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
e.default={name:"fetch",initialize:function(e){const o=e.lookup("service:fastboot");(0,t.setupFastboot)(o.get("request"))}}})

//# sourceMappingURL=docs-fastboot-aea12b7dad3c314b79211a5dbaa93f56.map