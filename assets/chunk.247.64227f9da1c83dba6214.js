/*! For license information please see chunk.247.64227f9da1c83dba6214.js.LICENSE.txt */
...
return e&&isFinite(e)?1e3*e:1/0}_setVolume(e){this._hasControl&&this._player&&this._controller&&(this._player.volumeLevel=e/100,this._controller.setVolumeLevel())}play(){let e=window.chrome.cast.media.PlayerState,t=this._player?.playerState
...
r.r(t),r.d(t,{EVENT_MAP:()=>Ce,SERVICE_EVENT_MAP:()=>Te,default:()=>rt})
...
"undefined"!=typeof Node&&e instanceof Node&&e.remove(),this._element=null,this._access=null}}var K,Q
const Z=f()("ember-stereo:cast")
let Y=(K=class{constructor({audioElement:e,onAvailabilityChange:t,onTargetChange:r}){(0,n.b)(this,"type","airplay"),(0,n.b)(this,"iconName","airplay"),(0,n.a)(this,"deviceAvailable",Q,this),this.audioElement=e,this.onAvailabilityChange=t,this.onTargetChange=r}static supports(e){return"function"==typeof e.webkitShowPlaybackTargetPicker}watch(){let e=this.audioElement.element
this._availabilityListener=e=>{this.deviceAvailable="available"===e.availability,this.onAvailabilityChange()},e.addEventListener("webkitplaybacktargetavailabilitychanged",this._availabilityListener),this._targetChangeListener=()=>this.onTargetChange(!!e.webkitCurrentPlaybackTargetIsWireless),e.addEventListener("webkitcurrentplaybacktargetiswirelesschanged",this._targetChangeListener)}unwatch(){let e=this.audioElement._element
e&&(this._availabilityListener&&(e.removeEventListener("webkitplaybacktargetavailabilitychanged",this._availabilityListener),this._availabilityListener=null),this._targetChangeListener&&(e.removeEventListener("webkitcurrentplaybacktargetiswirelesschanged",this._targetChangeListener),this._targetChangeListener=null))}prepare(){}get elementIsCasting(){return!!this.audioElement._element?.webkitCurrentPlaybackTargetIsWireless}get sessionAdoptable(){return!0}elementSession(){return{usesLocalElement:!0,deviceName:"AirPlay"}}sessionEnded(){}currentRemoteUrl(){return null}get hasLiveSession(){return!0}isStaleCastConnection(){return!1}showPicker(){Z("showing the AirPlay picker"),this.audioElement.prime(),this.audioElement.element.webkitShowPlaybackTargetPicker()}stopCasting(){this.audioElement.element.webkitShowPlaybackTargetPicker()}strategyFor(e,t,r,n){return this.audioElement.strategyFor(e,t,n)}teardown(){this.unwatch()}},Q=(0,n._)(K.prototype,"deviceAvailable",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),K)
var J=r(9581)
const X=f()("ember-stereo:google-cast-sdk"),ee="ember-stereo:cast:session-id"
class te{constructor(){(0,n.b)(this,"owner",null),(0,n.b)(this,"_player",null),(0,n.b)(this,"_controller",null),(0,n.b)(this,"_session",null),(0,n.b)(this,"_handlers",null),(0,n.b)(this,"_contextListeners",null),(0,n.b)(this,"_context",null),(0,n.b)(this,"_setupStarted",!1)}debug(e){X(e)}get context(){return this._context}ensureSetup(e){this._setupStarted||(this._setupStarted=!0,this._setup(e))}async _setup(e){let t=await(0,J.y)()
...
if(t)try{window.localStorage.setItem(ee,t)}catch(e){this.debug(`could not save session id: ${e}`)}}_clearSavedSessionId(){try{window.localStorage.removeItem(ee)}catch(e){this.debug(`could not clear session id: ${e}`)}}_savedSessionId(){try{return window.localStorage.getItem(ee)}catch(e){return null}}teardown(){this._context&&this._contextListeners&&Object.keys(this._contextListeners).forEach(e=>this._context.removeEventListener(e,this._contextListeners[e])),this._contextListeners=null,this._context=null,this._setupStarted=!1,this.forgetSession()}requestSession(){this._context?.requestSession().catch(e=>{this.debug(`cast requestSession error: ${e}`)})}endSession(){this._context?.endCurrentSession(!0)}get deviceName(){let e=this._session?.getCastDevice?.()
...
return e?.mediaInfo&&e.playerState!==t?.IDLE?e.mediaInfo.contentId:null}get hasLiveSession(){return!this.sdkSession||!!this.sdk.session}isStaleCastConnection(e){return this.sdkSession&&e?.connectionKey===oe.default.key&&!this.sdk.hasControl(e)}showPicker(){this.canStartSdkSession?(ae("requesting a Cast SDK session"),this.sdk.requestSession()):(ae("showing the Remote Playback prompt"),this.audioElement.prime(),this.audioElement.element.remote.prompt().catch(e=>{ae(`cast prompt error: ${e}`)}))}stopCasting(){this.hasSdkSession?this.sdk.endSession():this.audioElement.element.remote.disconnect?.()}strategyFor(e,t,{startTime:r,autoplay:n}={},i){return this.sdkSession?new $.default(oe.default,new U.default(e),{metadata:t,options:{castAccess:this.sdk,startTime:r,autoplay:n}}):this.audioElement.strategyFor(e,t,i)}teardown(){this.unwatch(),this.sdk.teardown()}},ne=(0,n._)(re.prototype,"remotePlaybackSeesDevices",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),ie=(0,n._)(re.prototype,"sdkSeesDevices",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),se=(0,n._)(re.prototype,"sdkSession",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),re)
var ce,ue,de,he
const pe=f()("ember-stereo:cast"),fe=[Y,le]
let ge=(ce=class{constructor(e){(0,n.a)(this,"isCasting",ue,this),(0,n.a)(this,"deviceName",de,this),(0,n.a)(this,"_session",he,this),(0,n.b)(this,"audioElement",new G),(0,n.b)(this,"_driver",void 0),(0,n.b)(this,"detectAvailabilityTask",(0,i.buildTask)(()=>({context:this,generator:function*(){let e=this.activeDriver
...
if(pe(`engaging cast -> ${e?.castUrl??"(no current sound yet, holding the device)"}`),this.stereo.trigger("audio-cast-connecting",{sound:e}),this._needsSwap(e)){let t=e.isStream?null:e.position,r=this.buildCastConnection(e.castUrl,e.metadata,{startTime:t,autoplay:e._explicitPlayIntent})
...
if(pe(`disengaging cast (usesLocalElement=${t?.usesLocalElement}, playIntent=${e?._explicitPlayIntent})`),this.isCasting=!1,this.deviceName=null,this._session=null,this.activeDriver?.sessionEnded(),e&&this.isCastConnection(e.connection))if(t&&!t.usesLocalElement){let t=this.buildLocalConnection(e)
...
return t===H.default.key||t===oe.default.key}shouldCastUrl(e){return this.isCasting&&null!=e&&!!this.activeDriver?.hasLiveSession}isStaleCastConnection(e){return!!this.activeDriver?.isStaleCastConnection(e)}_findLocalStrategy(e){return(e||[]).find(e=>e.canPlay&&!this.isCastConnection(e))}buildLocalConnection(e){let t=this._findLocalStrategy(e.strategies)
if(!t){let r=this.stereo._buildStrategies((0,c.makeArray)(e._identifier),this.stereo.prepareLoadOptions(e.options))
t=this._findLocalStrategy(r)}return t?.createConnection()}teardown(){this.engageTask.cancelAll(),this.disengageTask.cancelAll(),this.ignoreTargetChangesTask.cancelAll(),this.detectAvailabilityTask.cancelAll(),this.activeDriver?.teardown(),this.audioElement.teardown()}},ue=(0,n._)(ce.prototype,"isCasting",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),de=(0,n._)(ce.prototype,"deviceName",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),he=(0,n._)(ce.prototype,"_session",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),ce)
function me(e){return"string"==typeof e&&""!==e?new U.default(e).key:e instanceof U.default?e.key:"object"==typeof e&&e?.url?new U.default(e).key:e}function ye(e){return null!=e&&("object"==typeof e||e.then)}class be{constructor(){(0,n.b)(this,"objectCache",new WeakMap),(0,n.b)(this,"keyCache",{})}has(e){let t=me(e)
return ye(t)?this.objectCache.has(t):t in this.keyCache}find(e){let t=me(e)
return ye(t)&&this.objectCache.has(t)?this.objectCache.get(t):this.keyCache[t]?this.keyCache[t]:void 0}store(e,t){let r=me(e)
r&&(ye(r)?this.objectCache.set(r,t):this.keyCache[r]=t)}}var ve,we,_e,ke=r(9553)
const Ee=["xhr","startPosition","streamPauseGraceMs","duration","seekable"]
let Ae=(ve=class{constructor(e,t){(0,n.a)(this,"urls",we,this),(0,n.a)(this,"options",_e,this),(0,u.assert)("urls must be provided to the strategizer",!(0,ke.isEmpty)(e)),this.urls=e,this.connections=t.connections,this.metadata=t.metadata,this.options=t}buildStrategy(e,t){let r={}
Ee.forEach(e=>{null!=this.options[e]&&(r[e]=this.options[e])})
...
r&&e.push(r)}):e=this.connections,(0,ke.isEmpty)(e))throw new Error("No connections selected")
...
return t.concat(r)}return e}},we=(0,n._)(ve.prototype,"urls",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),_e=(0,n._)(ve.prototype,"options",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),(0,n._)(ve.prototype,"strategies",[a.cached],Object.getOwnPropertyDescriptor(ve.prototype,"strategies"),ve.prototype),ve)
var xe=r(880),Se=r(1899)
const Ce=[{event:"audio-played",handler:"_relayPlayedEvent"},{event:"audio-paused",handler:"_relayPausedEvent"},{event:"audio-blocked",handler:"_relayBlockedEvent"},{event:"audio-ended",handler:"_relayEndedEvent"},{event:"audio-duration-changed",handler:"_relayDurationChangedEvent"},{event:"audio-position-changed",handler:"_relayPositionChangedEvent"},{event:"audio-loaded",handler:"_relayLoadedEvent"},{event:"audio-loading",handler:"_relayLoadingEvent"},{event:"audio-position-will-change",handler:"_relayPositionWillChangeEvent"},{event:"audio-will-rewind",handler:"_relayWillRewindEvent"},{event:"audio-will-fast-forward",handler:"_relayWillFastForwardEvent"},{event:"audio-metadata-changed",handler:"_relayMetadataChangedEvent"}],Te=[{event:"current-sound-changed"},{event:"current-sound-interrupted"},{event:"new-load-request"},{event:"pre-load"},{event:"audio-cast-availability-changed"},{event:"audio-cast-connecting"},{event:"audio-cast-connected"},{event:"audio-cast-disconnected"}]
var Re,Oe,De,Pe,Ne,Le,je,Me,Ie,qe,Fe
const Be=[...Ce.map(({event:e})=>e),"audio-load-error"]
let ze=(Re=class extends xe.A{constructor(e,t={}){super(...arguments),(0,n.a)(this,"_identifier",Oe,this),(0,n.a)(this,"options",De,this),(0,n.a)(this,"strategies",Pe,this),(0,n.a)(this,"failures",Ne,this),(0,n.a)(this,"_connection",Le,this),(0,n.a)(this,"_volume",je,this),(0,n.a)(this,"_castUrl",Me,this),(0,n.a)(this,"_metadata",Ie,this),(0,n.a)(this,"_debug",qe,this),(0,n.a)(this,"_collapsedInto",Fe,this),(0,n.b)(this,"_explicitPlayIntent",!1),(0,n.b)(this,"_urlsPromise",null),(0,n.b)(this,"_boundRelayHandlers",new Map),(0,n.b)(this,"loadTask",(0,i.buildTask)(()=>({context:this,generator:function*(e={}){this.stereo?._soundLoadStarted(this),this.stereo?.oneAtATime?.register(this)
...
var r
return(r=t,(0,c.A)((0,c.makeArray)(r)).uniq().reject(e=>(0,ke.isEmpty)(e))).map(e=>new U.default(e))}(this._identifier).catch(e=>{throw this._urlsPromise=null,e}),this._urlsPromise}_castStateMatches(){let e=this.stereo.cast.isCastConnection(this.connection)
...
return{position:e?.position,isPlaying:this._explicitPlayIntent,isStream:e?.isStream}}_registerEventRelays(e){e&&Be.forEach(t=>{let r=e=>this._relayEvent(t,e)
this._boundRelayHandlers.set(t,r),e.on(t,r)})}_relayEvent(e,t={}){"audio-played"===e&&(this._explicitPlayIntent=!0),this.trigger(e,{...t,sound:this})}_unregisterEventRelays(e){e&&Be.forEach(t=>{let r=this._boundRelayHandlers.get(t)
if(r){try{e.off(t,r)}catch(e){}this._boundRelayHandlers.delete(t)}})}_needsConnectionReresolve(){return this.isResolved&&!this._castStateMatches()}play(...e){return this._explicitPlayIntent=!0,this._needsConnectionReresolve()?this.load():this.connection?.play(...e)}pause(...e){return this._explicitPlayIntent=!1,this.connection?.pause(...e)}stop(...e){return this._explicitPlayIntent=!1,this.connection?.stop(...e)}togglePause(...e){return this._explicitPlayIntent=!this.isPlaying,this._needsConnectionReresolve()?this.load():this.connection?.togglePause(...e)}rewind(...e){return this.connection?.rewind(...e)}fastForward(...e){return this.connection?.fastForward(...e)}seek(...e){return this.connection?.seek(...e)}hasUrl(e,t={exact:!1}){return!!(0,Se.A)(this.urls,e,t)||(0,c.makeArray)(this._identifier).some(t=>(0,c.makeArray)(e).includes(t))}_setVolume(e){this._volume=e,this.connection?._setVolume(e)}get position(){return this.connection?.position}set position(e){this.connection&&(this.connection.position=e)}get duration(){return this.connection?.duration}get currentTime(){return this.connection?.currentTime}get startTime(){return this.connection?.startTime}get endTime(){return this.connection?.endTime}get percentLoaded(){return this.connection?.percentLoaded}get isBlocked(){return this.connection?.isBlocked}set isBlocked(e){this.connection&&(this.connection.isBlocked=e)}get isReady(){return this.connection?.isReady}get isPlaying(){return this.connection?.isPlaying}get isPaused(){return this.connection?.isPaused}get isLoaded(){return this.connection?.isLoaded}get hasPlayed(){return this.connection?.hasPlayed}get mimeType(){return this.connection?.mimeType}get isStream(){return this.connection?.isStream}get isRewindable(){return this.connection?.isRewindable}get isFastForwardable(){return this.connection?.isFastForwardable}get isSeekable(){return this.connection?.isSeekable}get id3Tags(){return this.connection?.id3Tags}get id3TagMetadata(){return this.connection?.id3TagMetadata}get connectionName(){return this.connection?.connectionName}get connectionKey(){return this.connection?.connectionKey}},Oe=(0,n._)(Re.prototype,"_identifier",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),De=(0,n._)(Re.prototype,"options",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Pe=(0,n._)(Re.prototype,"strategies",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Ne=(0,n._)(Re.prototype,"failures",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return[]}}),Le=(0,n._)(Re.prototype,"_connection",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),je=(0,n._)(Re.prototype,"_volume",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Me=(0,n._)(Re.prototype,"_castUrl",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),Ie=(0,n._)(Re.prototype,"_metadata",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return{}}}),qe=(0,n._)(Re.prototype,"_debug",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return{}}}),Fe=(0,n._)(Re.prototype,"_collapsedInto",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),Re)
var $e,Ue,He,Ve=r(7655)
let We=($e=class{constructor(e,t){(0,n.a)(this,"loaded",Ue,this),(0,n.a)(this,"connectionOrder",He,this),this.service=e,this.load(t),this.connectionOrder=t.map(e=>"string"==typeof e?e:e.name)}get connections(){return this.names.map(e=>this.loaded[e])}get names(){return this.connectionOrder.filter(e=>!!this.loaded[e])}get(e){return this.loaded[e]}load(e){(0,u.assert)(`[ember-stereo] ConnectionLoader needs an array of connection, you provided ${e}`,!(0,ke.isEmpty)(e)),e.forEach(e=>{let t,r
...
const t=(0,Ve._k)(e),r=(0,l.getOwner)(this.service).lookup(`ember-stereo@stereo-connection:${t}`),n=(0,l.getOwner)(this.service).lookup(`stereo-connection:${t}`)
return(0,u.assert)(`[ember-stereo] Could not load stereo connection ${t}`,n||r),n||r}},Ue=(0,n._)($e.prototype,"loaded",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return{}}}),He=(0,n._)($e.prototype,"connectionOrder",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return[]}}),$e)
var Ge,Ke,Qe,Ze,Ye,Je,Xe
const et=[{name:"NativeAudio"},{name:"Howler"},{name:"HLS"}],tt=["play","pause","stop","seekbackward","seekforward","seekto","previoustrack","nexttrack"]
let rt=(Xe=class e extends(o().extend(I())){constructor(){super(...arguments),(0,n.a)(this,"autoPlayAllowed",Ke,this),(0,n.b)(this,"_identityMap",new be),(0,n.b)(this,"_sounds",new w),(0,n.b)(this,"_previewSounds",new WeakSet),(0,n.a)(this,"_currentSound",Qe,this),(0,n.a)(this,"_volume",Ze,this),(0,n.a)(this,"_playbackSpeed",Ye,this),(0,n.a)(this,"isMobileDevice",Je,this),(0,n.b)(this,"_useSharedAudioElement",!1),(0,n.b)(this,"loadTask",(0,i.buildTask)(()=>({context:this,generator:function*(e,t){let r={metadata:{},...t}
...
e.registerOptionsForType("ember-stereo@stereo-connection",{instantiate:!1}),e.registerOptionsForType("stereo-connection",{instantiate:!1}),this.loadConnections(),this.defaultVolume=this.systemStereoOptions?.initialVolume||100,this.defaultPlaybackSpeed=this.systemStereoOptions?.defaultPlaybackSpeed||1,this.volume=this.defaultVolume,this.sharedAudioAccess=new z,this.oneAtATime=new q,this.cast=new ge(this),(0,l.setOwner)(this.cast,e)
...
t!==e&&(this._unregisterEvents(t),t?.isPlaying&&this.trigger("current-sound-interrupted",{sound:t}),e?(this._registerEvents(e),this._updateNowPlaying(e),e._setVolume(this.volume),f()("ember-stereo:service")(`setting current sound -> ${e.url}`)):(this._clearNowPlaying(),f()("ember-stereo:service")("setting current sound -> null")),this._currentSound=e,this.trigger("current-sound-changed",{sound:e,previousSound:t}))}loadConnections(e=this.systemStereoOptions?.connections||(0,c.A)(et)){return this.connectionLoader=new We(this,e),(0,l.setOwner)(this.connectionLoader,(0,l.getOwner)(this)),this}get connections(){return this.connectionLoader.connections}get connectionNames(){return this.connectionLoader.names}get sounds(){return[...this._sounds]}findSound(e){if(e instanceof ze)return e
if(!e)return
let t=(0,c.makeArray)(e)[0],r=this._identityMap.find(t)
if(r)return r.canonical
let n=new ze(e,{owner:(0,l.getOwner)(this)})
...
document.addEventListener("touchstart",r,{passive:!0}),e.one("audio-played",()=>{document.removeEventListener("touchstart",r)}),e.play(t)}willDestroy(){this.loadTask.cancelAll(),this.playTask.cancelAll(),this.cast.teardown()}},(0,n.b)(Xe,"POSITION_STATE_INTERVAL_MS",1e3),Ge=Xe,Ke=(0,n._)(Ge.prototype,"autoPlayAllowed",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),Qe=(0,n._)(Ge.prototype,"_currentSound",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),Ze=(0,n._)(Ge.prototype,"_volume",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return this.defaultVolume}}),Ye=(0,n._)(Ge.prototype,"_playbackSpeed",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return this.defaultPlaybackSpeed}}),Je=(0,n._)(Ge.prototype,"isMobileDevice",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return"ontouchstart"in window}}),Ge)},1998:function(e,t,r){"use strict"
var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}}
...
//# sourceMappingURL=chunk.247.64227f9da1c83dba6214.map